...
This skill teaches OpenCode to apply systematic sequential thinking methodology for complex problem-solving, without relying on external MCP tools. It enables:
...
## When OpenCode Should Use This Skill
