...
Repomix packs entire repositories into single, AI-friendly files. Perfect for feeding codebases to LLMs like Antigravity, ChatGPT, and Gemini.
...
- Antigravity Sonnet 4.5: ~200K tokens
- GPT-4: ~128K tokens
- GPT-3.5: ~16K tokens
