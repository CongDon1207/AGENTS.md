...
node .agent/skills/project-index/scripts/scan-structure.js . 4

# Output to file
node .agent/skills/project-index/scripts/scan-structure.js . 4 > docs/structure.md

# JSON format
node .agent/skills/project-index/scripts/scan-structure.js . 4 json
```

### Python Script
```bash
# Basic usage
python .agent/skills/project-index/scripts/scan_structure.py . 4

# Output to file  
python .agent/skills/project-index/scripts/scan_structure.py . 4 > docs/structure.md

# JSON format
python .agent/skills/project-index/scripts/scan_structure.py . 4 json
```
